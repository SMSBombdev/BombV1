...
while 1:
    ...
    Başladığında kapatmak için: CTRL + C           {}Yapan {}@RivenShadow\n  
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "1 2 3 gibi numara seç bekleyin..")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        ...
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTYELLOW_EX + "Telefon numaralarının kayıtlı olduğu dosyanın dizinini yazın: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
            ...
            try:
                ...
                sonsuz = "(Sonsuz ise (enter) tuşuna basın..)"  
            except ValueError:
                system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Kaç (saniye) göndermek istiyorsunuz..: "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Çıkış yapıyor bekle..")
        break
    elif menu == 2:
        system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + " EMail adresi Bilmiyorsanız (enter) tuşuna basın: "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
        ...
        try:
            ...
            system("cls||clear")
            print("\nCtrl+C tuş algılandı Menüye dönülüyor..")
            sleep(2)
